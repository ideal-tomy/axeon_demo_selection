...
| quality-incident | 掲載 | available | 流れ完成（紹介→デモ→3手）。Vercel反映 | 完了 | 2026-09-21 |
| kaigo-handoff | 掲載 | available | 流れ完成（紹介→デモ→3手）。戻り導線・Vercel反映 | 完了 | 2026-09-21 |
...
| approval-inspection | 掲載 | available | 流れ完成（紹介→実画面タブ→3手）。Vercel反映 | 完了 | 2026-09-21 |
...
| wholesale-quote | 掲載 | available | 流れ完成（紹介→`/desk`→3手）。Vercel反映 | 完了 | 2026-09-22 |
...
| field-dandori | 掲載 | available | Phase2/3完了（根拠・確定・準備）。Vercel反映・LP要否判断 | 完了 | 2026-09-22 |
